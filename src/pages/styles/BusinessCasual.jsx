...
import BusinessCasualMale from './BusinessCasualMale';
import BusinessCasualFemale from './BusinessCasualFemale';
  ...
  return (
    ...
    >
      <div className="mb-8 flex flex-col items-center">
        <h1 className="text-4xl font-bold mb-2 text-center">💼 Business Casual</h1>
        <p className="mb-4 text-lg font-semibold">Select your gender to see personalized business casual style ideas:</p>
      ...
      {gender === 'male' && <BusinessCasualMale />}
      {gender === 'female' && <BusinessCasualFemale />}
    </motion.div>
  );
};

export default BusinessCasual;
