...
import VintageRetroMale from './VintageRetroMale';
import VintageRetroFemale from './VintageRetroFemale';
  ...
  return (
    ...
    >
      <div className="mb-8 flex flex-col items-center">
        <p className="mb-4 text-lg font-semibold">Select your gender to see personalized vintage/retro style ideas:</p>
      ...
      {gender === 'male' && <VintageRetroMale />}
      {gender === 'female' && <VintageRetroFemale />}
    </motion.div>
  );
};

export default VintageRetro;
