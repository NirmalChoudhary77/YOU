...
import ChicWearMale from './ChicWearMale';
import ChicWearFemale from './ChicWearFemale';
  ...
  return (
    ...
    >
      <div className="mb-8 flex flex-col items-center">
        <p className="mb-4 text-lg font-semibold">Select your gender to see personalized chic style ideas:</p>
      ...
      {gender === 'male' && <ChicWearMale />}
      {gender === 'female' && <ChicWearFemale />}
    </motion.div>
  );
};
