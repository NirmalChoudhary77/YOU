...
import TomboyStyleMale from './TomboyStyleMale';
import TomboyStyleFemale from './TomboyStyleFemale';
  ...
  return (
    ...
    >
      <div className="mb-8 flex flex-col items-center">
        <h1 className="text-4xl font-bold mb-2 text-center">🖤 Tomboy Style</h1>
        <p className="mb-4 text-lg font-semibold">Select your gender to see personalized tomboy style ideas:</p>
      ...
      {gender === 'male' && <TomboyStyleMale />}
      {gender === 'female' && <TomboyStyleFemale />}
    </motion.div>
  );
};

export default TomboyStyle;
