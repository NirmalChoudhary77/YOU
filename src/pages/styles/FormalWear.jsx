...
import FormalWearMale from './FormalWearMale';
import FormalWearFemale from './FormalWearFemale';
  ...
  return (
    ...
    >
      <div className="mb-8 flex flex-col items-center">
        <h1 className="text-4xl font-bold mb-2 text-center">🕵️ Formal / Evening Wear</h1>
        <p className="mb-4 text-lg font-semibold">Select your gender to see personalized formal/evening wear ideas:</p>
      ...
      {gender === 'male' && <FormalWearMale />}
      {gender === 'female' && <FormalWearFemale />}
    </motion.div>
  );
};
