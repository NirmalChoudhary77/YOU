...
import CasualWearMale from './CasualWearMale';
import CasualWearFemale from './CasualWearFemale';
  ...
  return (
    ...
    >
      <div className="mb-8 flex flex-col items-center">
        <p className="mb-4 text-lg font-semibold">Select your gender to see personalized casual wear ideas:</p>
      ...
      {gender === 'male' && <CasualWearMale />}
      {gender === 'female' && <CasualWearFemale />}
    </motion.div>
  );
};
