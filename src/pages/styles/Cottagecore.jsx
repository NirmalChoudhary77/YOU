...
import CottagecoreMale from './CottagecoreMale';
import CottagecoreFemale from './CottagecoreFemale';
  ...
  return (
    ...
    >
      <div className="mb-8 flex flex-col items-center">
        <h1 className="text-4xl font-bold mb-2 text-center">🌼 Cottagecore Style</h1>
        <p className="mb-4 text-lg font-semibold">Select your gender to see personalized cottagecore style ideas:</p>
      ...
      {gender === 'male' && <CottagecoreMale />}
      {gender === 'female' && <CottagecoreFemale />}
    </motion.div>
  );
};

export default Cottagecore;
