...
import GrungeStyleMale from './GrungeStyleMale';
import GrungeStyleFemale from './GrungeStyleFemale';
  ...
  return (
    ...
    >
      <div className="mb-8 flex flex-col items-center">
        <p className="mb-4 text-lg font-semibold">Select your gender to see personalized grunge style ideas:</p>
      ...
      {gender === 'male' && <GrungeStyleMale />}
      {gender === 'female' && <GrungeStyleFemale />}
    </motion.div>
  );
};
