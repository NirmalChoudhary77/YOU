...
import StreetwearMale from './StreetwearMale';
import StreetwearFemale from './StreetwearFemale';
  ...
  return (
    ...
    >
      <div className="mb-8 flex flex-col items-center">
        <p className="mb-4 text-lg font-semibold">Select your gender to see personalized streetwear style ideas:</p>
      ...
      {gender === 'male' && <StreetwearMale />}
      {gender === 'female' && <StreetwearFemale />}
    </motion.div>
  );
};
