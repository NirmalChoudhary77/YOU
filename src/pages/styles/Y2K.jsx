...
import Y2KMale from './Y2KMale';
import Y2KFemale from './Y2KFemale';
  ...
  return (
    ...
    >
      <div className="mb-8 flex flex-col items-center">
        <p className="mb-4 text-lg font-semibold">Select your gender to see personalized Y2K style ideas:</p>
