...
import AthleisureMale from './AthleisureMale';
import AthleisureFemale from './AthleisureFemale';
  ...
  return (
    ...
    >
      <div className="mb-8 flex flex-col items-center">
        <p className="mb-4 text-lg font-semibold">Select your gender to see personalized athleisure style ideas:</p>
      ...
      {gender === 'male' && <AthleisureMale />}
      {gender === 'female' && <AthleisureFemale />}
    </motion.div>
  );
};
