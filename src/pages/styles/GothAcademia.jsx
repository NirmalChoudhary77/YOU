...
import GothAcademiaMale from './GothAcademiaMale';
import GothAcademiaFemale from './GothAcademiaFemale';
  ...
  return (
    ...
    >
      <div className="mb-8 flex flex-col items-center">
        <h1 className="text-4xl font-bold mb-2 text-center">🖤 Goth/Dark Academia Style</h1>
        <p className="mb-4 text-lg font-semibold">Select your gender to see personalized goth/dark academia style ideas:</p>
      ...
      {gender === 'male' && <GothAcademiaMale />}
      {gender === 'female' && <GothAcademiaFemale />}
    </motion.div>
  );
};

export default GothAcademia;
