...
import AndrogynousStyleMale from './AndrogynousStyleMale';
import AndrogynousStyleFemale from './AndrogynousStyleFemale';
  ...
  return (
    ...
    >
      <div className="mb-8 flex flex-col items-center">
        <h1 className="text-4xl font-bold mb-2 text-center">⚡ Androgynous Style</h1>
        <p className="mb-4 text-lg font-semibold">Select your gender to see personalized androgynous style ideas:</p>
      ...
      {gender === 'male' && <AndrogynousStyleMale />}
      {gender === 'female' && <AndrogynousStyleFemale />}
    </motion.div>
  );
};

export default AndrogynousStyle;
