...
import BohemianStyleMale from './BohemianStyleMale';
import BohemianStyleFemale from './BohemianStyleFemale';
  ...
  return (
    ...
    >
      <div className="mb-8 flex flex-col items-center">
        <p className="mb-4 text-lg font-semibold">Select your gender to see personalized bohemian style ideas:</p>
      ...
      {gender === 'male' && <BohemianStyleMale />}
      {gender === 'female' && <BohemianStyleFemale />}
    </motion.div>
  );
};
