...
import PreppyMale from './PreppyMale';
import PreppyFemale from './PreppyFemale';
  ...
  return (
    ...
    >
      <div className="mb-8 flex flex-col items-center">
        <p className="mb-4 text-lg font-semibold">Select your gender to see personalized preppy style ideas:</p>
      ...
      {gender === 'male' && <PreppyMale />}
      {gender === 'female' && <PreppyFemale />}
    </motion.div>
  );
};

export default Preppy;
