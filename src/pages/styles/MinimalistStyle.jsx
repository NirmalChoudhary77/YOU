...
import MinimalistStyleMale from './MinimalistStyleMale';
import MinimalistStyleFemale from './MinimalistStyleFemale';
  ...
  return (
    ...
    >
      <div className="mb-8 flex flex-col items-center">
        <p className="mb-4 text-lg font-semibold">Select your gender to see personalized minimalist style ideas:</p>
      ...
      {gender === 'male' && <MinimalistStyleMale />}
      {gender === 'female' && <MinimalistStyleFemale />}
    </motion.div>
  );
};
