...
import ClassyElegantMale from './ClassyElegantMale';
import ClassyElegantFemale from './ClassyElegantFemale';
  ...
  return (
    ...
    >
      <div className="mb-8 flex flex-col items-center">
        <p className="mb-4 text-lg font-semibold">Select your gender to see personalized classy & elegant style ideas:</p>
      ...
      {gender === 'male' && <ClassyElegantMale />}
      {gender === 'female' && <ClassyElegantFemale />}
    </motion.div>
  );
};

export default ClassyElegant;
